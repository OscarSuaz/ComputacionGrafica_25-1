...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f));//Posición inicial del modelo
		modelaux = model;
		modelinf = model;
		...
		model = glm::rotate(model, toRadians*45 ,glm::vec3(0.0f,1.0f,0.0f));
		modelaux = model;
		...
		modelinf = model;
		{
			...
			model = glm::translate(model, glm::vec3(-3.8f, 3.5f, 0.0f));
			...
			//Artuculación 2
			model = glm::translate(model, glm::vec3(-1.2f, 2.0f, 0.0f));
		...
		modelinf = model;
		{
			...
			//Artuculación 2
			model = glm::translate(model, glm::vec3(-1.2f, 2.0f, 0.0f));
			model = glm::rotate(model, -glm::radians(mainWindow.getarticulacion0()), glm::vec3(1.0f, 0.0f, 0.0f));
			modelaux = model;
			model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			sp.render();

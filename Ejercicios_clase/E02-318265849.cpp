...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Techo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.6f, -6.0f));
		model = glm::scale(model, glm::vec3(0.67f, 0.35f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		//Arbol1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.8f, -0.85f, -0.6f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.8f, -0.525f, -0.6f));
		model = glm::scale(model, glm::vec3(0.15f, 0.23f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));

...
int main()
{
	...
	Arco_M = Model();
	Arco_M.LoadModel("Models/Puente.obj");
	Letrero_M = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Letrero
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, 0.6f));
		model = glm::translate(model, glm::vec3(0.0f,movCoche,0.0f));
		model = glm::rotate(model, toRadians * 180, glm::vec3(0.0f, 1.0f, 0.0f));

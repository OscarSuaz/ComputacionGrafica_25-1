...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Piso
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.8f, -6.0f));
		model = glm::scale(model, glm::vec3(7.0f, 0.01f, 7.0f));
		...
		//techo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.25f, -6.0f));
		...
		//ventana front l
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.4f, 0.4f, -5.44f));
		...
		//ventana front r
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.30f, 0.4f, -5.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Puerta
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -5.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//ventana side 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.4f, -5.65f));
		model = glm::scale(model, glm::vec3(1.53f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//ventana side 2
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.4f, -6.4f));
		model = glm::scale(model, glm::vec3(1.53f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Arbol 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.5f, -0.1f, -6.0f));
